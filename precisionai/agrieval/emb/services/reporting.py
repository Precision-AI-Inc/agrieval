...
def print_result(result: dict) -> None:
    """Pretty-print the output of :func:`~precisionai.agrieval.emb.services.evaluate.run_image2image_eval`.
...
def _subgroup_labels(paths: list[str]) -> list[str]:
    ...
    For canonical paths of the form ``images/{L2}/filename``, this returns
    the L2 subgroup (the parent directory).  For flat paths that

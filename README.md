...
See [CONTRIBUTING.md](CONTRIBUTING.md) for setup, branching, and PR guidelines. [CLAUDE.md](CLAUDE.md) documents the code style standards and conventions enforced in this repo — read it before contributing.
